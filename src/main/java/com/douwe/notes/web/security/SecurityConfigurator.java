        ...
        http.csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
                ...
                .authorizeRequests()
                    .antMatchers("/**/*.js", "/css/*.css", "/img/**", "/fonts/**")
                        .permitAll()
                    .antMatchers(HttpMethod.POST, "/api/utilisateurs", "/api/cycles", "/api/niveaux", "/api/departements", "/api/semestres", "/api/annees")
                        .access("hasRole('ADMINISTRATEUR')")
                    .antMatchers(HttpMethod.PUT, "/api/utilisateurs/**", "/api/cycles/**", "/api/niveaux/**", "/api/departements/**", "/api/semestres/**", "/api/annees/**")
                        .access("hasRole('ADMINISTRATEUR')")
                    .antMatchers(HttpMethod.DELETE, "/api/utilisateurs/**", "/api/cycles/**", "/api/niveaux/**", "/api/departements/**", "/api/semestres/**", "/api/annees/**")
                        .access("hasRole('ADMINISTRATEUR')")
                    .antMatchers(HttpMethod.GET, "/modules/utilisateur/**", "/modules/cycle/**", "/modules/niveau/**", "/modules/departement/**", "/modules/semestre/**", "/modules/annee/**")
                        .access("hasRole('ADMINISTRATEUR')")
